  ...
  function search() {
      ...
      setTimeout(() => {
          ...
          if (student) {
              ...
              <div  style='border: 1px solid gray; position: relative; margin-top: 20px; width: 343px'>
                 ...
                 <p style='text-align: center;'>B.C.A. V Semester (DEC-JAN 2025)</p>
         ...
         <div style='border: 1px solid gray; border-top-color: gray; width: 343px'>
